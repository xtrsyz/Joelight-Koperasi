...
If Keyascii = 13 Then
    Call BukaDB
    RSKasir.Open "Select NamaKsr from TBLKasir where NamaKsr ='" & TxtNamaKsr & "'", Conn
...
If Keyascii = 13 Then
    ...
    Call BukaDB
    RSKasir.Open "Select * from TBLKasir where NamaKsr ='" & TxtNamaKsr & "' and PasswordKsr='" & TxtPasswordKsr & "'", Conn
    If RSKasir.EOF Then
        B = B + 1
        If 1 - B = 0 Then
    ...
    Else
        ...
        Login.Visible = False
        MENU.Show
        MsgBox "PROGRAM INI GRATIIIISSSS..."
        
        KodeKasir = RSKasir!Kodeksr
        NamaKasir = RSKasir!Namaksr
        Kodeksr = KodeKasir
        Namaksr = NamaKasir
        MENU.StatusBar1.Panels(1) = KodeKasir
        MENU.StatusBar1.Panels(2) = NamaKasir
