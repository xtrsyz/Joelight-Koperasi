...
Else
    ...
    Else
        Dim aa As String
        aa = "insert into Pendaftaran(Tanggal,NIM,NamaMhs,Jurusan,Kelas,TanggalLhr,TempatLhr,Gender,Agama,Telepon,Ortu,Alamat,Kota,kodeopr) values ('" & TglDaftar & "','" & TNIM & "','" & TNama & "','" & LBJurusan & "','" & LBKelas & "','" & CDate(TanggalLhr) & "','" & TempatLhr & "','" & CBGender & "','" & CBAgama & "','" & TTelepon & "','" & TOrtu & "','" & TAlamat & "','" & TKota & "','" & KodeOpr & "')"
        Conn.Execute aa
        Adodc1.Refresh
        DataGrid1.Refresh
...
Else
    ...
    Else
        Dim cc As String
        cc = "Update pendaftaran set Namamhs='" & TNama & "',TanggalLhr='" & TanggalLhr & "',TempatLhr='" & TempatLhr & "',Gender='" & CBGender & "',agama='" & CBAgama & "',telepon='" & TTelepon & "',ortu='" & TOrtu & "',alamat='" & TAlamat & "',kota='" & TKota & "',kodeopr='" & KodeOpr & "' where nim='" & TNIM & "'"
        Conn.Execute cc
